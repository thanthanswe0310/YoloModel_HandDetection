    ...
    with open('weights/step.csv', 'w') as f:
        ...
        for epoch in range(args.epochs):
            ...
            if args.local_rank == 0:
                ...
                torch.save(ckpt, '/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/weights/best.pt')
                if best == last[1]:
                    torch.save(ckpt, '/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/weights/best.pt')
                del ckpt

    if args.local_rank == 0:
        util.strip_optimizer('/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/weights/best.pt')  # strip optimizers
        util.strip_optimizer('/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/weights/last.pt')  # strip optimizers
...
def test(args, params, model=None):
    filenames = []  
    with open('/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/Dataset/COCO/labels/val2017/111.txt') as reader:
        for filename in reader.readlines():
            filename = filename.rstrip().split('/')[-1]
            filenames.append('/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/Dataset/COCO/images/val2017/' + filename)
    ...
    if model is None:
        model = torch.load('/home/tricubics/Desktop/Yolo-Hand-Detection/yolov8_hand_detection/YOLOv8-pt/weights/best.pt', map_location='cuda')['model'].float()
